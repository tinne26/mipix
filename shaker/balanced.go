...
//
// You can set the motion range to 0.02 and travel time to
...
// Same idea as [Bezier.SetMaxMotionRange](). Defaults to 0.01.
func (self *Balanced) SetMaxMotionRange(axisRatio float64) {
	if axisRatio <= 0.0 {
		self.axisRatio = 0.05
	} else {
